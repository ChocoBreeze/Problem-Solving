...
int chk = 0;
void make_sum(vector<int>& a, vector<long long>& result, int now, int end, long long sum, int S, int& only) {
	if (now > end) {
...
int main() {
	...
	int answer = only_front + only_back;
